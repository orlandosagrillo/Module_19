...
##########################################
# Step 1 - Part 4: Call the `generate_account` function and save it as the variable `account`
...
st.sidebar.markdown("---------")
##########################################
# Step 1 - Part 5: Call `get_balance` function and pass it your account address
